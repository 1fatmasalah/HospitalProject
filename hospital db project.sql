...
use Hospital_DB;
create table departments (department_id varchar(10),name varchar(30),
location varchar(50), phone varchar(20));
...
create table doctors(doctor_id varchar(100),department_id varchar(100),
first_name varchar(100),last_name varchar(100),specialization varchar(100),phone varchar(100),email varchar(100));
...
create table patients(patient_id varchar(100),first_name varchar(100),last_name varchar(10),
date_of_birth varchar(100),gender varchar(10),address varchar(100) , phone varchar (100) , email varchar(100),
emergency_contact varchar(100) , blood_type varchar(10), allergies varchar(100));
...
create table appointments(appointments_id varchar(100),appointment_date varchar(100),
appointment_time varchar(100), status varchar(100) ,reason varchar(100),notes varchar(100),
department_id varchar(100) ,doctor_id varchar(100), patient_id varchar(100));
...
create table medical_records( medical_records_id varchar(100),
patient_id varchar(100), appointment_id varchar(100), diagnosis varchar(100), treatment varchar(100),
record_date varchar(100), notes varchar(100), doctor_id varchar(100));
...
create table prescriptions (prescriptions_id varchar(100), 
patient_id varchar(100), medical_record_id varchar(100),
prescription_date varchar(100), notes varchar(100), doctor_id varchar(100));
...
create table medicines (medicines_id varchar(100), 
name varchar(100), description varchar(100), stock_quantity int ,
unit_price float , expiry_date varchar(100));
...
create table prescription_medicines (prescription_medicines_id varchar(100), prescription_id varchar(100),
medicine_id varchar(100), dosage varchar(100), frequency varchar(100), duration varchar(100));
...
create table  lab_tests (lab_tests_id varchar(100), name varchar(100), description varchar(100), cost float);
...
create table lab_results (lab_results_id varchar(100), patient_id varchar(100), appointment_id varchar(100),
lab_test_id varchar(100), result varchar(100), result_date varchar(100), notes varchar(100));
...
create table bills (bills_id varchar(100), total_amount float , paid_amount float , payment_status varchar(100),
billing_date varchar(100), payment_method varchar(100), patient_id varchar(100), appointment_id varchar(100));
...
'ali.hassan@email.com','Fatima Hassan-971-555-0124','B+','None');
insert into medicines values ('MED016', 'Paracetamol', 'Pain reliever', 1500, 7.50, '2026-05-31'),
...
('PAT025', 'DOC003','2024-03-10', '10:30:00');
...
insert into lab_tests values ('LAB011', 'HIV Test', 'Test for HIV antibodies', 150.00),
 ...
 --8 HAVING Clause
SELECT department_id, COUNT(doctor_id) FROM doctors
GROUP BY department_id
HAVING COUNT(*) > 3;

SELECT doctor_id, COUNT(appointments_id)  FROM appointments
GROUP BY doctor_id
HAVING COUNT(appointments_id) > 5;

SELECT patient_id, COUNT(appointments_id)
FROM appointments
GROUP BY patient_id
...
HAVING AVG(unit_price) > 20;
 ...
 SELECT department_id,
       AVG(DATEDIFF(MINUTE, '00:00:00', CAST(appointment_time AS TIME))) 
FROM appointments
GROUP BY department_id
HAVING AVG(DATEDIFF(MINUTE, '00:00:00', CAST(appointment_time AS TIME))) > 30;
...
select distinct blood_type from patients;
...
select appointment_date as [visit date],appointment_time as [visit time ] from appointments;

select first_name +' ' + last_name as [Physician Name],specialization as speciality from doctors;

select total_amount as [amount charge],paid_amount as [amount paid] from bills;

select name as [drug name],unit_price as [price per unit]from medicines;
...
SELECT medicines_id, name, unit_price, description FROM medicines
WHERE unit_price > ALL (
    SELECT unit_price FROM medicines
    WHERE description = 'Pain Reliever');
...
SELECT appointments_id, patient_id, doctor_id, appointment_time FROM appointments
...
SELECT SUBSTRING(blood_type, 1, 3)  FROM patients;

SELECT LTRIM(RTRIM(address)) FROM patients;

SELECT REPLACE(allergies, 'None', 'No Known Allergies') AS updated_allergies FROM patients;
